...
def build_tools() -> List[Dict[str, Any]]:                 # ✏️ Build 1, step 1.3
    ...
    return [
        ...
        },
        {
            ...
            "description": (
                "Search Altura for alternative Larkspur flights to rebook a passenger whose "
                "segment was disrupted. Call this once you know the original flight is "
                "cancelled or delayed and the customer needs a new flight. Takes only the PNR; "
                "origin, destination, date and cabin are read from the booking. Returns "
                "available options, each with an option_id and its flight number(s) and "
                "departure/arrival times. Pass an option_id to hold_seat to place a hold."
            ),
            "input_schema": {
                "type": "object",
